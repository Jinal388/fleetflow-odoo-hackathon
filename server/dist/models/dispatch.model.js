...
const dispatchSchema = new mongoose_1.Schema({
    ...
    status: { type: String, enum: Object.values(constants_1.DISPATCH_STATUS), default: constants_1.DISPATCH_STATUS.PENDING },
...
exports.Dispatch = mongoose_1.default.model('Dispatch', dispatchSchema);
